...
describe('OAuthTokenProvider tests', function () {
    ...
    var pageContextProvider = new PageContext_1.default(rootScope);
    var pageContextInfo = {
        cultureInfo: {
            currentCultureName: '',
    ...
    pageContextProvider.initialize(pageContextInfo);
    rootScope.provide(PageContext_1.pageContextServiceKey, pageContextProvider);
    rootScope.finish();
    ...
    it('Should get the correct token in case of a successfull request', function () {
        fetchProvider.expect({
            expectedUrl: '/sites/test/_api/contextinfo',
            responseObject: {
    ...
    function setFetchProviderExpectation(expectations) {
        ...
        fetchProvider.expect({
            expectedUrl: '/sites/test/_api/SP.OAuth.Token/Acquire',

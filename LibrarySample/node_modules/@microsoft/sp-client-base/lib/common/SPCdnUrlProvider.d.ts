...
export default class SPCdnUrlProvider {
     ...
     */
    static initialize(cdnOriginList: string[]): void;
    /**
     ...
     */
    static getCdnUrlIfEnabled(url: string): string;
}

define("af59c2b3-2da7-41fd-8b72-3939817960af", ["@microsoft/sp-lodash-subset"], function(__WEBPACK_EXTERNAL_MODULE_85__) { return /******/ (function(modules) { // webpackBootstrap
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Environment_1 = __webpack_require__(116);
	...
	var sp_client_shared_1 = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StringHelper = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var regex = new RegExp('sp-client-base_?[a-zA-Z0-9]*.js', 'i');
	var found = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// OneDrive:IgnoreCodeCoverage
	"use strict";
	var DatetimeResx = __webpack_require__(8);
	var Locale_1 = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Manager_1 = __webpack_require__(11);
	var CorrelationVector_1 = __webpack_require__(14);
	var _id = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ObjectUtil_1 = __webpack_require__(12);
	var handlers = [];
	var buffer = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Guid_1 = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleEventBase_1 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PairedEventBase_1 = __webpack_require__(22);
	var ResultTypeEnum_1 = __webpack_require__(23);
	var ResultTypeEnum_2 = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// OneDrive:IgnoreCodeCoverage
	"use strict";
	var CaughtError_event_1 = __webpack_require__(25);
	var QosError_event_1 = __webpack_require__(26);
	var Verbose_event_1 = __webpack_require__(27);
	var CircularBuffer_1 = __webpack_require__(28);
	var ObjectUtil_1 = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ErrorHelper_1 = __webpack_require__(24);
	var BeaconBase_1 = __webpack_require__(31);
	var BeaconCache_1 = __webpack_require__(35);
	var BaseDataStore_1 = __webpack_require__(36);
	var DataStoreCachingType_1 = __webpack_require__(37);
	var LogProcessor_1 = __webpack_require__(38);
	var Beacon;
	(function (Beacon) {
	    "use strict";
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Manager_1 = __webpack_require__(11);
	var EventBatchCache_1 = __webpack_require__(32);
	var XHR_1 = __webpack_require__(34);
	var Beacon_event_1 = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Qos_event_1 = __webpack_require__(21);
	var PLT_event_1 = __webpack_require__(39);
	var Beacon_event_1 = __webpack_require__(33);
	var UnhandledError_event_1 = __webpack_require__(40);
	var RequireJSError_event_1 = __webpack_require__(41);
	var CaughtError_event_1 = __webpack_require__(25);
	var QosError_event_1 = __webpack_require__(26);
	var Verbose_event_1 = __webpack_require__(27);
	var Engagement_event_1 = __webpack_require__(16);
	var EventBase_1 = __webpack_require__(10);
	var RUMOneDataUpload_event_1 = __webpack_require__(42);
	var DebugPriorityLevel_1 = __webpack_require__(43);
	var LogProcessor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageTransitionType_1 = __webpack_require__(47);
	var RUMOneSLAPI_1 = __webpack_require__(50);
	var RUMOneErrorsSLAPI_1 = __webpack_require__(51);
	var RUMOneDataUpload_event_1 = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var StringHelper_1 = __webpack_require__(6);
	var MembersList_1 = __webpack_require__(55);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventBase_1 = __webpack_require__(10);
	var Manager_1 = __webpack_require__(11);
	var BeforeUnload_1 = __webpack_require__(59);
	var Beacon_event_1 = __webpack_require__(33);
	var ErrorHelper_1 = __webpack_require__(24);
	var PlatformDetection_1 = __webpack_require__(56);
	...
	var AriaLogger = (function () {
	    ...
	    AriaLogger.initialize = function (tenantToken, context) {
	        __webpack_require__.e/* nsure */(1, function (require) {
	            var aria = __webpack_require__(60);
	            try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var HslColor_1 = __webpack_require__(62);
	var RgbaColor_1 = __webpack_require__(63);
	var Shades_1 = __webpack_require__(64);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var RgbaColor_1 = __webpack_require__(63);
	var ThemeCache_1 = __webpack_require__(67);
	var Promise_1 = __webpack_require__(48);
	var Engagement_event_1 = __webpack_require__(16);
	var Qos_event_1 = __webpack_require__(21);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	"use strict";
	var LogFeature_1 = __webpack_require__(69);
	var LogType_1 = __webpack_require__(70);
	/**
	 * @internal
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogSource = (function () {
	    ...
	    function LogSource(id) {
	        Validate_1.default.isNotNullOrUndefined(id, 'id');
	        this.id = id;
	    }
	    /**
	    ...
	    /**
	     * @returns {boolean} - if the LogSource is empty.
	     */
	...
	exports.logSourceServiceKey = ServiceKey_1.default.createCustom('sp-client-base:LogSource', function (serviceScope) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var odsp_utilities_bundle_1 = __webpack_require__(4);
	var ApplicationLogSettings_1 = __webpack_require__(76);
	var LogEvent_1 = __webpack_require__(78);
	var LogLevel_1 = __webpack_require__(81);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var odsp_utilities_bundle_1 = __webpack_require__(4);
	var BeaconHandlers_1 = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var LogSource_1 = __webpack_require__(71);
	var LogManager_1 = __webpack_require__(79);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var CircularBuffer_1 = __webpack_require__(80);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ServiceKey_1 = __webpack_require__(73);
	var lodash = __webpack_require__(85);
	var FetchProvider_1 = __webpack_require__(86);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @public
	 */
	exports.fetchProviderServiceKey = ServiceKey_1.default.create('sp-client-base:FetchProvider', FetchProvider);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ServiceKey_1 = __webpack_require__(73);
	var DigestCache_1 = __webpack_require__(88);
	/**
	 * The service key for IDigestCache.
	 * @public
	 */
	exports.digestCacheServiceKey = ServiceKey_1.default.create('sp-client-base:DigestCache', DigestCache_1.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlUtilities_1 = __webpack_require__(89);
	var FetchProvider_1 = __webpack_require__(86);
	var TimeProvider_1 = __webpack_require__(90);
	var LogSource_1 = __webpack_require__(71);
	var TraceLogger_1 = __webpack_require__(75);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.dateProviderServiceKey = ServiceKey_1.default.create('sp-client-base:TimeProvider', TimeProvider);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicHttpClient_1 = __webpack_require__(84);
	var ODataBatch_1 = __webpack_require__(92);
	var HttpClientCommon_1 = __webpack_require__(95);
	var RandomProvider_1 = __webpack_require__(94);
	var PerformanceLogger_1 = __webpack_require__(82);
	var LogSource_1 = __webpack_require__(71);
	var QosMonitor_1 = __webpack_require__(74);
	/**
	...
	var HttpClient = (function (_super) {
	    ...
	    HttpClient.prototype._fetchWithInstrumentation = function (request) {
	        ...
	        var qosMonitor = new QosMonitor_1.default('SPHttpClient');
	        var fetch = this.fetchCore(request).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var lodash = __webpack_require__(85);
	var ODataBatchedRequest_1 = __webpack_require__(93);
	var HttpClient_1 = __webpack_require__(91);
	var Guid_1 = __webpack_require__(1);
	var FetchProvider_1 = __webpack_require__(86);
	var RandomProvider_1 = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RandomProvider = (function () {
	    function RandomProvider(serviceScope) {
	        // (this constructor is currently unused, but it is required by the
	        // ServiceKey.create() contract)
	    }
	    RandomProvider.prototype.getRandom = function () {
	        return Math.random();
	    };
	    return RandomProvider;
	}());
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = RandomProvider;
	exports.randomProviderServiceKey = ServiceKey_1.default.create('sp-client-base:RandomProvider', RandomProvider);
	...
	var PageContext = (function () {
	    ...
	    PageContext.prototype.initialize = function (options) {
	        ...
	        this._web = new SPWeb_1.default(options.web || {
	            absoluteUrl: '',
	            id: '',
	            permissions: SPPermission_1.default.emptyMask.value,
	            serverRelativeUrl: '',
	            title: ''
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPWeb = (function () {
	    ...
	    function SPWeb(data) {
	        ...
	        this._id = Guid_1.default.tryParse(data.id);
	        this._permissions = new SPPermission_1.default(data.permissions) || SPPermission_1.default.emptyMask;
	    ...
	    Object.defineProperty(SPWeb.prototype, "id", {
	        /**
	         * The GUID that identifies the SPWeb on the server. This property could be undefined
	         * if the information isn't avalible.
	         */
	        get: function () {
	            return this._id;
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPSite = (function () {
	    ...
	    Object.defineProperty(SPSite.prototype, "id", {
	        /**
	         * The GUID that identifies the SPSite on the server. This property could be undefined
	         * if the information isn't avalible.
	         */
	        get: function () {
	            return this._id;
...
/***/ function(module, exports) {
	...
	var CultureInfo = (function () {
	    ...
	    function CultureInfo(data) {
	        ...
	        this._isRightToLeft = data && data.isRightToLeft ?
	            true :
	            false;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var sp_client_shared_1 = __webpack_require__(111);
	var OAuthUtilityContext_1 = __webpack_require__(115);
	var ServiceKey_1 = __webpack_require__(73);
	var Validate_1 = __webpack_require__(72);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var OAuthUtility_1 = __webpack_require__(112);
	exports.OAuthUtility = OAuthUtility_1.default;
	var OAuthUtilityError_1 = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OAuthUtility = (function () {
	     ...
	     *          with an instance of TokenUtilityError
	     */
	    OAuthUtility.prototype.getOAuthToken = function (resource) {
	        var _this = this;
	        ...
	        return this._retriableFetchWithDigest(resource, Constants_1.default.retries)
	     ...
	     */
	    OAuthUtility.prototype._retriableFetchWithDigest = function (resource, retriesLeft) {
	        var _this = this;
	        ...
	        return this._context.fetchWithDigest(this._buildTokenRequest(resource))
	            ...
	            if (response.status !== 200) {
	                ...
	                return response.json()
	                    ...
	                    var errorCode = _this._getErrorCodeFromResponseCode(errorResponse.error.code);
	                    ...
	                    return _this._retriableFetchWithDigest(resource, retriesLeft - 1);
	                });
	            }
	    ...
	    OAuthUtility.prototype._getCacheKey = function (resource) {
	        return ['sp-client-shared', Constants_1.default.npmPackageVersion, 'OAuthUtility', resource].join(';');
	    };
	    ...
	    OAuthUtility.prototype._buildTokenRequest = function (resource) {
	        ...
	        var webUrlNoEndingSlash = this._context.webUrl;
	    ...
	    OAuthUtility.prototype._buildErrorFromResponse = function (serverErrorResponse) {
	        var serverError = serverErrorResponse.error;
	        var errorCode = this._getErrorCodeFromResponseCode(serverError.code);
	     ...
	     */
	    OAuthUtility.prototype._getErrorCodeFromResponseCode = function (responseErrorCode) {
...
/***/ function(module, exports) {
	...
	var OAuthUtilityError = (function (_super) {
	    ...
	    function OAuthUtilityError(type, context) {
	        _super.call(this, context.message);
	        this._type = type;
	...
	})(exports.OAuthUtilityErrorType || (exports.OAuthUtilityErrorType = {}));
	var OAuthUtilityErrorType = exports.OAuthUtilityErrorType;
	...
	var OAuthUtilityContext = (function () {
	    function OAuthUtilityContext(serviceScope) {
	        ...
	        serviceScope.whenFinished(function () {
	            ...
	            _this._pageContext = serviceScope.consume(PageContext_1.pageContextServiceKey);
	    ...
	    Object.defineProperty(OAuthUtilityContext.prototype, "webUrl", {
	        get: function () {
	            return this._pageContext.web.serverRelativeUrl;
	        },
	        enumerable: true,
	        configurable: true
	    });

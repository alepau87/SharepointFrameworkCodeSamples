...
var SearchBox = (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        }}, React.createElement("i", {className: 'ms-SearchBox-icon ms-Icon ms-Icon--Search'}), label), React.createElement("button", {className: 'ms-SearchBox-closeButton', onMouseDown: this._onClose}, React.createElement("i", {className: 'ms-Icon ms-Icon--Cancel'}))));
    };

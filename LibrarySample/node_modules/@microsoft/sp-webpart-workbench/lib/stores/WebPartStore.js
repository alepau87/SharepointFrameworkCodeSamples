    ...
    WebPartStore.prototype.fetchWebParts = function () {
        ...
        if (!this.isLoading) {
            ...
            if (window.webpartManifests) {
                ...
                var tryHandleWebpartsPromise_1 = function (promise) {
                    return promise
                ...
                tryHandleWebpartsPromise_1(window.fetch('https://localhost:5432/getwebparts'))
                    .catch(function (ex) { return tryHandleWebpartsPromise_1(window.fetch('http://localhost:5432/getwebparts')); })
                    .catch(function (ex) {
                    console.error(ex);

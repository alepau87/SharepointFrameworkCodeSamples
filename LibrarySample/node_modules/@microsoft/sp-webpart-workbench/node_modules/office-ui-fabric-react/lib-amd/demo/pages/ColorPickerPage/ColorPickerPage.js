...
define(["require", "exports", 'react', '../../components/index', './examples/ColorPicker.Basic.Example', '../../utilities/pageroute', '../../components/App/AppState'], function (require, exports, React, index_1, ColorPicker_Basic_Example_1, pageroute_1, AppState_1) {
    ...
    var ColorPickerPage = (function (_super) {
        ...
        ColorPickerPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, {title: 'ColorPicker', componentName: 'ColorPickerExample', exampleCards: [
                React.createElement(index_1.ExampleCard, {title: 'ColorPicker', code: ColorPickerBasicExampleCode}, React.createElement(ColorPicker_Basic_Example_1.ColorPickerBasicExample, null))
            ], propertiesTables: [
                React.createElement(index_1.PropertiesTableSet, {componentName: 'ColorPicker'})
            ], overview: React.createElement("div", null, "ColorPicker is used to allow a user to select a color"), route: this._url, isHeaderVisible: this.props.isHeaderVisible}));
        };

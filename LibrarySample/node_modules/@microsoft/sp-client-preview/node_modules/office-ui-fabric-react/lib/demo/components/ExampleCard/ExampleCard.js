...
var ExampleCard = (function (_super) {
    ...
    ExampleCard.prototype.render = function () {
        ...
        return (React.createElement("div", {className: rootClass}, React.createElement("div", {className: 'ExampleCard-header'}, React.createElement("span", {className: 'ExampleCard-title ms-font-l'}, title), React.createElement("span", {className: 'ExampleCard-toggleButtons ms-font-l'}, React.createElement(Button_1.Button, {buttonType: Button_1.ButtonType.primary, onClick: this._onShowExampleClick}, isExampleShown ? 'Hide example' : 'Show example'), code ? (React.createElement(Button_1.Button, {buttonType: Button_1.ButtonType.primary, onClick: this._onToggleCodeClick, className: isCodeVisible ? 'is-open' : ''}, '</>')) : (null))), React.createElement("div", {className: css_1.css('ExampleCard-content', { ' ms-u-slideDownIn20': (isCodeVisible) })}, isCodeVisible && (React.createElement("div", {className: 'ExampleCard-code ms-u-slideDownIn20'}, React.createElement(Highlight, {className: 'javascript'}, code))), isExampleShown && (React.createElement("div", {className: css_1.css('ExampleCard-example', { ' is-right-aligned': (isRightAligned) })}, children))), this._getDosAndDonts()));
    };
    ExampleCard.prototype._getDosAndDonts = function () {
        if (this.props.dos && this.props.donts) {
            return (React.createElement("div", {className: 'ExampleCard-dosAndDonts'}, React.createElement("div", {className: 'ExampleCard-dos'}, React.createElement("h4", null, "Do"), this.props.dos), React.createElement("div", {className: 'ExampleCard-donts'}, React.createElement("h4", null, "Do not"), this.props.donts)));
        }
    };

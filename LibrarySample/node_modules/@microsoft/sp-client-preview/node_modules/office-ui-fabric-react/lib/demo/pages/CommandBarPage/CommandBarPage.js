...
var CommandBarPage = (function (_super) {
    ...
    CommandBarPage.prototype.render = function () {
        ...
        return (React.createElement(index_2.ComponentPage, {title: 'CommandBar', componentName: 'CommandBarExample', exampleCards: [
            React.createElement(index_2.ExampleCard, {title: 'CommandBar with search box and overflowing menu items', code: CommandBarBasicExampleCode}, React.createElement(CommandBar_Basic_Example_1.CommandBarBasicExample, React.__spread({}, cmdBarParamsTextAndIcons))),

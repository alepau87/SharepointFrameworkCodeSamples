define([], function() {
  var strings = {
    "_3TQNOPdunsdXO/TupbQUNg": {
      "ManifestNullError": "Manifest for the webpart {0} is null.",
      "ReadOnlyPropertyError": "Readonly property",
      "BaseConstructError": "BaseClientSideWebPart is an abstract class and should not be constructed as is.",
      "ConstructLog": "Constructed web part: {0}",
      "SerializeLog": "Serialized web part: {0}",
      "DisposeLog": "Disposed web part: {0}",
      "MustOverrideRenderError": "Render needs to be overriden in the derived class.",
      "NonBaseWebPartError": "All webparts must inherit from the BaseClientSideWebPart class.",
      "BaseConstructorNotCalledError": "super.contructor needs to be called in the first line of the derived class constructor.",
      "PropertyBagNullError": "Null property bag is not allowed.",
      "GenericError": "Webpart with id '{0}' errored due to '{1}'",
      "UndefinedModuleError": "Web part module is not loaded or not defined in the manifest.",
      "ModuleNotLoadedError": "Bootstrap module for webpart '{0}' not loaded. Module name in the manifest is '{1}'. Module names exported by the bundle are '{2}'.",
      "IncorrectBoostrapModuleError": "Bootstrap module for webpart '{0}' not of the correct type. Make sure to export your webpart as 'export default WebPartName'.",
      "ScriptLoadErrorTemplate": "Unable to load web part script resources due to: {0}.",
      "LoadingStatus": "Loading {0}...",
      "OnInitReturnedNullPromise": "Web part onInit returned null or undefined Promise.",
      "OnDisplayModeChangedInvalidInvocation": "Web part onDisplayModeChanged should not be called if there is no change in the display mode.",
      "GenericAccessibleLabelTemplate": "{0} web part"
    },
    "_K8RuMFp89V7G6GfKxZQtOg": {
      "Save": "Apply",
      "Close": "Close",
      "SaveConfirmation": "Your changes on the property pane have been saved",

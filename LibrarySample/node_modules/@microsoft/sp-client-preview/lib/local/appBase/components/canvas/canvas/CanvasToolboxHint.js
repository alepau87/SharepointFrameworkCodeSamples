...
var CanvasToolboxHint = (function (_super) {
    ...
    CanvasToolboxHint.prototype.render = function () {
        ...
        var hint = (React.createElement("button", {"aria-label": this.props.ariaLabel, className: "CanvasToolboxHint  " + attachedCssClass, onClick: this._handleClick}, React.createElement("div", {className: 'CanvasToolboxHint-plusButton'}, React.createElement("i", {className: 'ms-Icon ms-Icon--Add'}))));

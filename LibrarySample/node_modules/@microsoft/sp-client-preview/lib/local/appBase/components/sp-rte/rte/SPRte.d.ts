...
export default class SPRte extends React.Component<ISPRteProps, ISPRteState> {
    ...
    private _createNewEditorMonitor;
    ...
    private _getFormatButtonProps(formatKey, onClick, shouldBeDisabled?);
    private _formattingBarButtons;
    private _shouldDisableLinkButton();
    ...
    private _engagementLoggerClickTagName(key);
}

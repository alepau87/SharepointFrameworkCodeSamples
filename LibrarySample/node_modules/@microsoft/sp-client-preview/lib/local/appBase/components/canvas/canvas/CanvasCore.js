...
var CanvasCore = (function (_super) {
    ...
    CanvasCore.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'Canvas'}, React.createElement("div", {className: 'ms-Grid'}, toolboxHint, rows), React.createElement(CanvasToolbox_1.default, __assign({}, this.props.toolboxProps))));
    };

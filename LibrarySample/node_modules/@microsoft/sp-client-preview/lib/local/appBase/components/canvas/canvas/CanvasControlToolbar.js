...
var CanvasControlToolbar = (function (_super) {
    ...
    CanvasControlToolbar.prototype.render = function () {
        ...
        if (this.props.onConfigureButtonClick) {
            configureButton = (React.createElement(ToolbarButton_1.default, {key: 'config', fabricIconKey: 'Edit', onClick: this.props.onConfigureButtonClick, title: CanvasStrings_resx_1.default.ToolbarConfigButtonTitle}));
        }
        return (React.createElement("div", {className: 'CanvasControlToolbar'}, configureButton, this.props.buttons, React.createElement(ToolbarButton_1.default, {key: 'trash', fabricIconKey: 'Delete', onClick: this.props.onDeleteButtonClick, title: CanvasStrings_resx_1.default.ToolbarDeleteButtonTitle})));
    };

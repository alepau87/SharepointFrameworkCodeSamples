import { DisplayMode, ServiceScope, _QosMonitor } from '@microsoft/sp-client-base';
...
export default class CanvasStore {
    ...
    handleToolboxItemClick(row: number, itemProps: ISerializedCanvasControl): void;

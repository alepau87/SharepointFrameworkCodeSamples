 ...
 */
import { DisplayMode, _QosMonitor } from '@microsoft/sp-client-base';
...
import { WebPartConfigurationEvent } from '../propertyPane/propertyPane/PropertyPaneDefinitions';
/**
...
export interface IClientSideWebPartInternal {
    ...
    _internalFirstTimeRender(mode: DisplayMode, qosMonitor?: _QosMonitor, data?: IWebPartData): Promise<void>;
    _internalSetDisplayMode(newDisplayMode: DisplayMode): void;
    _internalGetPropertyPaneSettings(): IPropertyPaneData;
    _internalOnPropertyChange(propertyPath: string, newValue: any): void;
    _internalOnConfigurationEvent(configurationEvent: WebPartConfigurationEvent): void;

import { ServiceScope, IODataWeb, IODataNavigationNodeCollection, IODataContextWebInformation } from '@microsoft/sp-client-base';
import { IClientSideApplicationManifest, IClientSideComponentManifest } from '@microsoft/sp-module-interfaces';
...
export default class PreloadedDataReader {
    ...
    private _isValid;
    private static _toNavNodes(srcNodes, pageContext);
    constructor(preloadedData: IPreloadedData);
    initializeDigestCache(serviceScope: ServiceScope): void;
    initializePageContext(pageContext: PageContext): void;
    private _initNav(target, source, pageContext);
}

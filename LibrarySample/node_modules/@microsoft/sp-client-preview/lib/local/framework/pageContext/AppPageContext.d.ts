...
export default class AppPageContext {
    ...
    private _list;
    private _listItem;
    private _quickLaunch;
    private _topNav;
    private _core;
    private _user;
    private _urlQueryParameters;
     ...
     */
    quickLaunch: SPNavigationNodeCollection;
    /**
     * Top navigation information for the page.
     * If unsure whether this object is initialized, check the SPNavigation.state property first.
     */
    topNav: SPNavigationNodeCollection;
    /**
     ...
     */
    urlQueryParameters: UrlQueryParameterCollection;
}
export declare const appPageContextServiceKey: ServiceKey<AppPageContext>;

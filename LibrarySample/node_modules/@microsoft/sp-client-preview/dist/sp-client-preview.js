...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"1":"sp-client-telemetry","2":"sp-client-preview-quill","3":"sp-client-preview-propertypane"}[chunkId]||chunkId) + "_" + {"1":"e984992cc077a9bc559c","2":"5b263aa7d1119de24018","3":"fe92d758cef424ebaa21"}[chunkId] + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventAggregator_1 = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseClientSideWebPart = (function () {
	    ...
	    function BaseClientSideWebPart(ctx) {
	        ...
	        this._propertyPaneRenderedByWebPart = false;
	    ...
	    Object.defineProperty(BaseClientSideWebPart.prototype, "title", {
	         ...
	         * @readonly
	         */
	        get: function () { return this._title || this.context.manifest.title.default; },
	        /**
	         * @internal
	         */
	        set: function (o) { this._throwReadOnlyError(); },
	    ...
	    Object.defineProperty(BaseClientSideWebPart.prototype, "description", {
	         ...
	         * @readonly
	         */
	        get: function () { return this._description || this.context.manifest.description.default; },
	        /**
	         * @internal
	         */
	        set: function (o) { this._throwReadOnlyError(); },
	    ...
	    Object.defineProperty(BaseClientSideWebPart.prototype, "propertyPaneRenderedByWebPart", {
	         ...
	         */
	        get: function () { return this._propertyPaneRenderedByWebPart; },
	        /**
	         * @internal
	         */
	        set: function (o) { this._throwReadOnlyError(); },
	    ...
	    BaseClientSideWebPart.prototype.configureStart = function (refreshOnly) {
	        ...
	        this._webPartCalledConfigureStart = true;
	    ...
	    BaseClientSideWebPart.prototype._internalGetPropertyPaneSettings = function () {
	        ...
	        /**
	         * Reason we want to maintain two different booleans is to maintain the state of the
	         * '_propertyPaneRenderedByWebPart' until it's changed at later point of time.
	         * '_webPartCalledConfigureStart' has to change immediately and hence cannot use this
	         * varaible to maintain the property pane rendered state.
	         */
	        this._propertyPaneRenderedByWebPart = !!this._webPartCalledConfigureStart;
	        return {
	     ...
	     */
	    /* tslint:disable:no-unused-variable */
	    BaseClientSideWebPart.prototype._internalOnPropertyChange = function (propertyPath, newValue) {
	        /* tslint:enable:no-unused-variable */
	    ...
	    BaseClientSideWebPart.prototype._internalOnConfigurationEvent = function (configurationEvent) {
	        ...
	        switch (configurationEvent) {
	            ...
	            case PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneApplyClicked:
	                ...
	                break;
	            case PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneWebPartsSwitched:
	                // resetting the value.
	                this._webPartCalledConfigureStart = false;
	                break;
	        }
	    };
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createShortDateFormatters() {
	    'use strict';
	    var locale = [window['$Config'] && window['$Config']['mkt'], Locale_1.default.language, navigator.language, 'en'].filter(function (str) { return !!str; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ErrorHelper = (function () {
	    ...
	    ErrorHelper._getErrorMessage = function (error) {
	        var message = '';
	        if (error) {
	            if (error.message) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* tslint:disable */
	var styles = {
	    errorBox: 'errorBox_4c2c6c48',
	    errorBoxText: 'errorBoxText_bc74efee',
	    screenReaderOnly: 'screenReaderOnly_959b95e8',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".errorBox_4c2c6c48{font-family:\"Segoe UI WestEuropean\",\"Segoe UI\",-apple-system,BlinkMacSystemFont,Roboto,\"Helvetica Neue\",sans-serif;-webkit-font-smoothing:antialiased;font-size:15px;font-weight:400;color:#ff3a46;padding:12px 0;overflow:hidden;position:relative;top:0;left:0;right:0;z-index:1}.errorBoxText_bc74efee{text-align:left;position:relative;padding-right:28px;display:inline-block}.screenReaderOnly_959b95e8{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MockPreloadedPageData = (function () {
	    function MockPreloadedPageData() {
	        ...
	        this.webServerRelativeUrl = 'https://localhost:4321';
	        this.webAbsoluteUrl = 'https://localhost:4321';
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var SuiteNavManagerConfiguration_1 = __webpack_require__(85);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	"use strict";
	var SuiteNavLinkIds_1 = __webpack_require__(86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApplicationContext_1 = __webpack_require__(88);
	var SPWeb_1 = __webpack_require__(91);
	var SPSite_1 = __webpack_require__(93);
	var SPList_1 = __webpack_require__(94);
	var SPListItem_1 = __webpack_require__(95);
	var SPUser_1 = __webpack_require__(96);
	var SPNavigationNodeCollection_1 = __webpack_require__(97);
	var PageContextCore_1 = __webpack_require__(98);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageContextItem_1 = __webpack_require__(89);
	var GuidHelpers_1 = __webpack_require__(90);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactDOM = __webpack_require__(80);
	var sp_client_base_1 = __webpack_require__(69);
	var CanvasComponent_1 = __webpack_require__(101);
	var CanvasStore_1 = __webpack_require__(168);
	...
	var Canvas = (function () {
	    ...
	    Canvas.prototype.openToolbox = function (row) {
	        ...
	        if (this._store.displayMode === sp_client_base_1.DisplayMode.Edit &&
	            0 <= row &&
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(79);
	var ReactDOM = __webpack_require__(80);
	var css_1 = __webpack_require__(102);
	var sp_client_base_1 = __webpack_require__(69);
	var CanvasControlFactory_1 = __webpack_require__(104);
	var CanvasZone_1 = __webpack_require__(137);
	var CanvasA11y_1 = __webpack_require__(114);
	var CanvasToolboxHint_1 = __webpack_require__(142);
	var ConfirmationDialog_1 = __webpack_require__(146);
	var Toolbar_1 = __webpack_require__(149);
	var Toolbox_1 = __webpack_require__(154);
	var CanvasStrings_resx_1 = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fabric = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var React = __webpack_require__(79);
	var CanvasControlType_1 = __webpack_require__(105);
	var SPRte_1 = __webpack_require__(106);
	var WebPartZone_1 = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var odsp_utilities_bundle_1 = __webpack_require__(6);
	var SPRteConfiguration_1 = __webpack_require__(107);
	var SPRteFormattingBar_1 = __webpack_require__(109);
	var SPRteLinkDialog_1 = __webpack_require__(113);
	var QuillEditor_1 = __webpack_require__(115);
	var ToolbarButton_1 = __webpack_require__(125);
	var ToolbarSubmenu_1 = __webpack_require__(129);
	var CanvasA11y_1 = __webpack_require__(114);
	...
	var SPRte = (function (_super) {
	    ...
	    function SPRte(props) {
	        ...
	        this._onAfterPaste = this._onAfterPaste.bind(this);
	        this._onBeforePaste = this._onBeforePaste.bind(this);
	        ...
	        this._preventEditorFocus = false;
	    ...
	    SPRte.prototype.componentDidMount = function () {
	        ...
	        if (this.state.displayMode === sp_client_base_1.DisplayMode.Edit) {
	            if (!this._createNewEditorMonitor) {
	                this._createNewEditorMonitor = new sp_client_base_1._QosMonitor(CREATE_EDITOR_MONITOR);
	            }
	            this._createNewEditor(this.props.innerHTML || '').then(function (editor) {
	                ...
	                _this._createNewEditorMonitor.writeUnexpectedFailure(CREATE_EDITOR_MONITOR_FAILURE, error, { 'innerHTML': _this.props.innerHTML });
	            });
	        }
	    };
	    SPRte.prototype.componentDidUpdate = function (prevProps, prevState) {
	        if (this.state.displayMode === sp_client_base_1.DisplayMode.Edit) {
	            if (this._formattingbar) {
	                ...
	                if (this.context.store && this.context.store.scrollableParent) {
	            ...
	            if (!isFloating && this._shouldFormattingBarStick()) {
	                if (this._isRtl) {
	                    right = right + window.innerWidth -
	                        this._editorElement.getBoundingClientRect().right - SPRte._CANVASZONE_PADDING_HORIZONTAL;
	                }
	                else {
	    ...
	    SPRte.prototype._getFormatButtonProps = function (formatKey, onClick, shouldBeDisabled) {
	        var format = this._config.formats.get(formatKey);
	        if (!shouldBeDisabled) {
	            shouldBeDisabled = this._buttonStates.get(format.key) === ToolbarButton_1.ButtonState.Disabled;
	        }
	        return {
	            key: format.key,
	    ...
	    Object.defineProperty(SPRte.prototype, "_formattingBarButtons", {
	        get: function () {
	            ...
	            var buttons = [
	                React.createElement(ToolbarSubmenu_1.default, {key: 'format', buttons: formatSubmenuButtons, isOpen: this.state.currentSubmenuOpen === 'format', isWide: true, onOpen: function () { return _this.setState({ currentSubmenuOpen: 'format' }); }, onClose: function () { return _this.setState({ currentSubmenuOpen: undefined }); }}),
	                ...
	                React.createElement(ToolbarSubmenu_1.default, {key: 'alignment', buttons: alignmentSubmenuButtons, isOpen: this.state.currentSubmenuOpen === 'alignment', onOpen: function () { return _this.setState({ currentSubmenuOpen: 'alignment' }); }, onClose: function () { return _this.setState({ currentSubmenuOpen: undefined }); }}),
	                React.createElement(ToolbarSubmenu_1.default, {key: 'list', buttons: listSubmenuButtons, isOpen: this.state.currentSubmenuOpen === 'list', onOpen: function () { return _this.setState({ currentSubmenuOpen: 'list' }); }, onClose: function () { return _this.setState({ currentSubmenuOpen: undefined }); }}),
	                React.createElement(ToolbarButton_1.default, __assign({}, this._getFormatButtonProps('link', this._handleLink, this._shouldDisableLinkButton()))),
	                React.createElement(ToolbarButton_1.default, {key: 'unlink', canBeActive: false, className: 'button_linkRemove_temp', fabricIconKey: 'Link', onClick: this._handleUnlink, title: CanvasStrings_resx_1.default.FormattingBarUnlinkButtonTitle, disabled: this._buttonStates.get('link') !== ToolbarButton_1.ButtonState.Active, automationId: 'unlink-button'}),
	                React.createElement(ToolbarButton_1.default, {key: 'clearFormatting', canBeActive: false, fabricIconKey: 'ClearFormatting', onClick: this._handleClearFormatting, title: CanvasStrings_resx_1.default.FormattingBarClearFormattingButtonTitle, automationId: 'clearFormatting-button'})
	            ];
	            return buttons;
	        },
	        enumerable: true,
	    ...
	    SPRte.prototype._shouldDisableLinkButton = function () {
	        if (this._editor) {
	    ...
	    SPRte.prototype._formatOrPrepare = function (formatKey) {
	        this.focus();
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName(formatKey), CLICK_ACTION);
	        var format = this._config.formats.get(formatKey);
	    ...
	    SPRte.prototype._handleLink = function () {
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName('link'), CLICK_ACTION);
	    ...
	    SPRte.prototype._handlePlainText = function () {
	        ...
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName('PlainText'), CLICK_ACTION);
	    };
	    ...
	    SPRte.prototype._handleClearFormatting = function () {
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName('ClearFormatting'), CLICK_ACTION);
	        this.focus();
	        var range = this._currentSelection;
	    ...
	    SPRte.prototype._handleTextChange = function () {
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName('TextChange'), CLICK_ACTION);
	        // Quill API doesn't provide afterPaste event, so we fake it by listening to focus event on editor element
	        // Quill focuses to another element as pasting buffer and after paste sets the focus back to the editor
	        if (this._isPasting) {
	            this._onAfterPaste();
	        }
	        if (this.state.displayMode === sp_client_base_1.DisplayMode.Edit) {
	    ...
	    SPRte.prototype._handleUnlink = function () {
	        this.focus();
	        sp_client_base_1._EngagementLogger.logEvent(this._engagementLoggerClickTagName('Unlink'), CLICK_ACTION);
	        if (this._currentSelection) {
	    ...
	    SPRte.prototype._onAfterPaste = function () {
	        var _this = this;
	        sp_client_base_1._EngagementLogger.logEvent(TAG_NAME + 'CopyPaste');
	        this._isPasting = false;
	    ...
	    SPRte.prototype._handleDocumentClick = function () {
	        this._preventEditorFocus = false;
	    };
	    SPRte.prototype._handleEditorFocus = function (evt) {
	        if (this._preventEditorFocus) {
	            if (this._formattingbarElement) {
	    ...
	    SPRte.prototype._handleKeyDown = function (evt) {
	        if (CanvasA11y_1.isTab(evt) || CanvasA11y_1.isShiftTab(evt)) {
	            evt.stopPropagation();
	            evt.preventDefault();
	        }
	        else if (CanvasA11y_1.isKey(CanvasA11y_1.KeyCodes.F10, evt, true) && this._formattingbarElement) {
	            sp_client_base_1._EngagementLogger.logEvent(TAG_NAME + 'ToolbarByKeyboardShortcut.Focus', evt.type);
	            this.context.store.a11yManager.navigateInside(this._formattingbarElement);
	    ...
	    SPRte.prototype._engagementLoggerClickTagName = function (key) {
	        return TAG_NAME + key + BUTTON_NAME + CLICK_ACTION;
	    };
	    SPRte.contextTypes = {
	        store: React.PropTypes.object.isRequired
	    };
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @copyright Microsoft Corporation. All rights reserved. *
	 */
	var office_ui_fabric_react_1 = __webpack_require__(103);
	var React = __webpack_require__(79);
	...
	var SPRteFormattingBar = (function (_super) {
	    ...
	    SPRteFormattingBar.prototype.render = function () {
	        ...
	        return (React.createElement("div", {role: 'toolbar', "aria-label": 'Formatting', className: className, ref: function (ref) { return _this._domNode = ref; }, style: style, "data-automation-id": 'toolbar'}, React.createElement(office_ui_fabric_react_1.FocusZone, {ref: function (ref) { return _this._focusZone = ref; }, isCircularNavigation: true}, this.props.buttons)));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPRteLinkDialog = (function (_super) {
	    ...
	    SPRteLinkDialog.prototype.render = function () {
	        ...
	        return (React.createElement(office_ui_fabric_react_1.Dialog, {isOpen: isOpen, type: office_ui_fabric_react_1.DialogType.normal, onDismiss: onDismiss, title: CanvasStrings_resx_1.default.LinkDialogTitle, isBlocking: true, elementToFocusOnDismiss: editorElement}, React.createElement(office_ui_fabric_react_1.TextField, {label: CanvasStrings_resx_1.default.LinkDialogTextFieldLabel, ariaLabel: CanvasStrings_resx_1.default.LinkDialogTextFieldAriaLabel, onChanged: this._handleTextFieldChange, onGetErrorMessage: this._getErrorMessage, onKeyDown: this._handleKeyDown, placeholder: 'http://', defaultValue: textFieldValue, ref: function (c) { return _this._textField = c; }}), React.createElement(office_ui_fabric_react_1.DialogFooter, null, React.createElement(office_ui_fabric_react_1.Button, {buttonType: office_ui_fabric_react_1.ButtonType.primary, disabled: !this.state.isURLValid, onClick: onSaveClicked, ariaLabel: CanvasStrings_resx_1.default.RichTextLinkDialogSaveButtonLabel}, CanvasStrings_resx_1.default.RichTextLinkDialogSaveButtonLabel), React.createElement(office_ui_fabric_react_1.Button, {onClick: onCancelClicked, ariaLabel: CanvasStrings_resx_1.default.RichTextLinkDialogCancelButtonLabel}, CanvasStrings_resx_1.default.RichTextLinkDialogCancelButtonLabel))));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	"use strict";
	var QuillLoader_1 = __webpack_require__(116);
	        ...
	        if (!QuillLoader._quillPromise) {
	            QuillLoader._quillPromise = new Promise(function (complete) {
	                __webpack_require__.e/* nsure */(2, function (require) {
	                    var quill = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolbarButton = (function (_super) {
	    ...
	    ToolbarButton.prototype.render = function () {
	        ...
	        /* Do NOT set aria-label to avoid "press F1 help" in JAWS when tooltip is set through title */
	        return (React.createElement("button", {"aria-disabled": this.props.disabled ? true : undefined, "aria-pressed": this.props.canBeActive ? this.props.isActive : undefined, className: buttonClassName, key: this.props.key, onClick: this.props.onClick, title: this.props.title, tabIndex: this.props.tabIndex, "data-automation-id": this.props.automationId, onKeyDown: this.props.onKeyDown ? this.props.onKeyDown : undefined}, React.createElement("i", {className: iconCssClass}), this.props.label));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolbarSubmenu = (function (_super) {
	    ...
	    function ToolbarSubmenu(props) {
	        ...
	        this._handleSubmenuKeyDown = this._handleSubmenuKeyDown.bind(this);
	        this._handleSubmenuItemsKeyDown = this._handleSubmenuItemsKeyDown.bind(this);
	    ...
	    ToolbarSubmenu.prototype.render = function () {
	        ...
	        return (React.createElement("div", {"aria-selected": this.state.isOpen, className: "ToolbarSubmenu " + openedCssClass + " " + wideCssClass}, React.createElement(ToolbarButton_1.default, {className: 'ToolbarSubmenu-displayButton', fabricIconKey: activeButton.fabricIconKey, iconClassName: activeButton.iconClassName, key: 'displayButton', onClick: this._handleOpenSubmenu, isActive: this._hasExplicitActiveButton, label: activeButton.label, tabIndex: this.state.isOpen ? -1 : 0, title: activeButton.title, onKeyDown: this._handleSubmenuItemsKeyDown, automationId: 'displayButton'}), React.createElement("i", {className: 'ms-Icon ms-Icon--CaretDownSolid8 ToolbarSubmenu-caret'}), React.createElement(office_ui_fabric_react_1.FocusZone, {isCircularNavigation: true}, React.createElement("div", {className: 'ToolbarSubmenu-menuItems', ref: function (c) { return _this._menuElement = c; }, onKeyDown: this._handleSubmenuKeyDown, "data-automation-id": 'subMenuContainer'}, buttonElements))));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ql-editor{cursor:text;margin:0;padding:0;min-height:100%;margin-bottom:-16px}.ql-editor:focus{outline:0}.ql-editor:focus{outline:0}.ql-paste-manager{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}.ql-editor.ql-ie-10 br,.ql-editor.ql-ie-9 br{display:none}.ql-editor blockquote,.ql-editor div,.ql-editor h2,.ql-editor h3,.ql-editor h4,.ql-editor ol,.ql-editor p,.ql-editor ul,.ql-editor.ql-blank::before{-webkit-font-smoothing:antialiased;color:\"[theme:neutralPrimary, default: #333333]\";font-family:\"Segoe UI Regular WestEuropean\",\"Segoe UI\",\"Segoe WP\",Tahoma,Arial,sans-serif;line-height:1.5;margin:0 0 16px 0;padding:0;white-space:pre-wrap;word-wrap:break-word}.ql-editor.ql-blank::before{color:\"[theme:neutralTertiary, default: #a6a6a6]\"!important;content:attr(data-placeholder);font-size:16px;font-style:normal;position:absolute;pointer-events:none}.ql-editor div,.ql-editor p{font-size:16px}.ql-editor h2,.ql-editor h3,.ql-editor h4{font-family:\"Segoe UI Light WestEuropean\",\"Segoe UI Light\",\"Segoe WP Light\",\"Segoe UI\",\"Segoe WP\",Tahoma,Arial,sans-serif;font-weight:400}.ql-editor h2{font-size:24px}.ql-editor h3{font-size:20px}.ql-editor h4{font-size:18px}.ql-editor ol,.ql-editor ul{font-family:\"Segoe UI Semilight WestEuropean\",\"Segoe UI Semilight\",\"Segoe WP Semilight\",\"Segoe UI\",\"Segoe WP\",Tahoma,Arial,sans-serif;font-size:16px;list-style-position:inside;padding:0}.ql-editor ol li,.ql-editor ul li{margin-bottom:8px}.ql-editor ol{list-style-type:decimal}.ql-editor ul{list-style-type:disc}.ql-editor blockquote,.ql-editor div.quote-true{border-bottom:1px solid \"[theme:neutralTertiaryAlt, default: #c8c8c8]\";border-top:1px solid \"[theme:neutralTertiaryAlt, default: #c8c8c8]\";border-bottom-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\";border-top-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\";font-family:\"Segoe UI Semilight WestEuropean\",\"Segoe UI Semilight\",\"Segoe WP Semilight\",\"Segoe UI\",\"Segoe WP\",Tahoma,Arial,sans-serif;font-size:20px;font-style:italic;margin:28px 0;padding:32px;text-align:center}.ql-editor a{text-decoration:underline}.ql-editor i{font-style:italic}.ql-editor u{text-decoration:underline}@media screen and (min-width:480px){.ql-editor h2{font-size:28px}.ql-editor h3{font-size:24px}.ql-editor h4{font-size:20px}.ql-editor blockquote,.ql-editor div.quote-true{font-size:24px}}@media screen and (min-width:1024px){.ql-editor h2{font-size:32px}.ql-editor h3{font-size:30px}.ql-editor h4{font-size:24px}.ql-editor div,.ql-editor p,.ql-editor.ql-blank::before{font-size:18px;line-height:1.75}.ql-editor ol,.ql-editor ul{font-size:18px;line-height:1.75}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var odsp_utilities_bundle_1 = __webpack_require__(6);
	var CanvasControlType_1 = __webpack_require__(138);
	var CanvasA11y_1 = __webpack_require__(114);
	var PropertyPaneDefinitions_1 = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog_1 = __webpack_require__(148);
	var CanvasStrings_resx_1 = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fabric = __webpack_require__(103);
	module.exports = fabric;
	module.exports.default = fabric.Dialog
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var FocusZone_1 = __webpack_require__(150);
	var React = __webpack_require__(79);
	var CanvasControlType_1 = __webpack_require__(138);
	var ToolbarButton_1 = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var sp_client_base_2 = __webpack_require__(69);
	var Spinner_1 = __webpack_require__(155);
	var odsp_utilities_bundle_1 = __webpack_require__(6);
	var CanvasControlType_1 = __webpack_require__(138);
	var ToolboxGroup_1 = __webpack_require__(156);
	var ToolboxItem_1 = __webpack_require__(160);
	var ToolboxItemClassifier_1 = __webpack_require__(164);
	var CanvasA11y_1 = __webpack_require__(114);
...
/***/ function(module, exports) {
	...
	var FEATURED_ITEM_IDS = [
	    // _0 is necessary for the first preconfigured entry of the webpart manifest
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".CanvasToolbox{background:\"[theme:white, default: #ffffff]\";border:1px solid #d6d6d6;box-shadow:0 0 8px 0 rgba(0,0,0,.2);box-sizing:border-box;height:330px;left:50%;margin-left:-146px;margin-top:26px;overflow-y:auto;position:absolute;width:292px;z-index:10}.CanvasToolbox .CanvasToolbox-Error{background-color:#fde7e9;font-family:\"Segoe UI Semibold WestEuropean\",\"Segoe UI Semibold\",\"Segoe WP Semibold\",\"Segoe UI\",\"Segoe WP\",Tahoma,Arial,sans-serif;font-size:12px;letter-spacing:1px;padding:0 12px}.CanvasToolbox .ms-Icon{font-family:sp-MDL2}.CanvasToolbox .ms-Spinner-container{margin-left:132px;margin-top:151px}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var sp_lodash_subset_1 = __webpack_require__(5);
	var sp_client_base_1 = __webpack_require__(69);
	var CanvasControlType_1 = __webpack_require__(138);
	var CanvasWebPartHost_1 = __webpack_require__(169);
	var ClientSideWebPartManager_1 = __webpack_require__(170);
	var PropertyPaneDefinitions_1 = __webpack_require__(3);
	var CanvasStrings_resx_1 = __webpack_require__(108);
	var CanvasStore = (function () {
	    ...
	    CanvasStore.prototype.handleToolboxItemClick = function (row, itemProps) {
	    ...
	    CanvasStore.prototype.createQosScope = function (scope) {
	        return new sp_client_base_1._QosMonitor("Canvas" + scope);
	    };
	    ...
	    CanvasStore.prototype._fetchWebParts = function () {
	        var _this = this;
	        if (!this._fetchedWebParts && sp_client_base_1.DisplayMode.Edit === this._displayMode) {
	            /**
	             ...
	             */
	            this._webPartManager.fetchWebParts().then(function () {
	    ...
	    CanvasStore.prototype._loadWebParts = function () {
	        var _this = this;
	            ...
	            this._getManifestMap().forEach(function (manifest, cid) {
	                ...
	                for (var _i = 0, _a = manifest.preconfiguredEntries; _i < _a.length; _i++) {
	                    ...
	                    var itemProps = {
	                        ...
	                        webPartManifest: sp_lodash_subset_1.merge(sp_lodash_subset_1.cloneDeep(manifest), entry)
	                    };
	                    var toolboxItem = {
	                        itemProps: itemProps,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasWebPartHost = (function () {
	    ...
	    CanvasWebPartHost.prototype.webPartConfigurationEventCallback = function (event) {
	        if (event === PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneOpened) {
	            /*
	        ...
	        else if (event === PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneClosed ||
	            event === PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneLostFocus) {
	            this._reclaimFocus();
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var lodash = __webpack_require__(5);
	var sp_module_loader_1 = __webpack_require__(171);
	var sp_client_base_1 = __webpack_require__(69);
	var odsp_utilities_bundle_1 = __webpack_require__(6);
	var BaseClientSideWebPart_1 = __webpack_require__(4);
	var ClientSideWebPartStatusRenderer_1 = __webpack_require__(172);
	var EventAggregator_1 = __webpack_require__(82);
	var Utils_1 = __webpack_require__(177);
	var PropertyPaneDefinitions_1 = __webpack_require__(3);
	var propertyPaneController_1 = __webpack_require__(178);
	var sp_client_base_2 = __webpack_require__(69);
	var Strings_resx_1 = __webpack_require__(71);
	var WebPartContext_1 = __webpack_require__(205);
	/**
	...
	var ClientSideWebPartManager = (function () {
	    ...
	    function ClientSideWebPartManager(host) {
	        ...
	        this._environment = host.serviceScope.consume(sp_client_base_1.environmentServiceKey);
	    ...
	    ClientSideWebPartManager.prototype.loadWebPart = function (context) {
	        ...
	        return new Promise(function (resolve, reject) {
	            ...
	            // If the WebPart has data, take the title
	            // If the WebPart has just been created from the Toolbox, use the title
	            // Otherwise we know nothing, use the title of the first entry
	                    ...
	                    try {
	                        ...
	                        if (_this._instanceOfBase(wpi)) {
	                            ...
	                            return wpi._internalFirstTimeRender(context.displayMode, qosMonitor, context.webPartData).then(function () {
	                                ...
	                                _this._disableButtonPostbacksForClassicPages(context.domElement);
	                                resolve();
	                            });
	                        }
	                        else {
	    ...
	    ClientSideWebPartManager.prototype.fetchWebParts = function () {
	        var _this = this;
	        // if webparts have already been fetched we don't have anything to do here.
	        if (!this._toolboxManifestsPromise) {
	            var qosMonitor_1 = new sp_client_base_2._QosMonitor('ClientSideWebPartManager.FetchWebParts');
	            this._toolboxManifestsPromise = new Promise(function (resolve, reject) {
	                ...
	                if (_this._pageContext.web &&
	                    ...
	                    var requestUrl_1 = sp_client_base_1.UrlUtilities.removeEndSlash(_this._pageContext.web.serverRelativeUrl) + "/_api/web/GetClientSideWebParts";
	                    _this._host.serviceScope.whenFinished(function () {
	                        ...
	                        httpClient.get(requestUrl_1)
	                            ...
	                            sp_client_base_1._TraceLogger.logVerbose(_this._logSource, 'Successfully loaded webpart manifests');
	    ...
	    ClientSideWebPartManager.prototype._createLoadQosMonitor = function (manifest) {
	        ...
	        return new sp_client_base_2._QosMonitor("WebPart." + manifest.id + ".Load");
	    };
	    /**
	    ...
	    ClientSideWebPartManager.prototype._getManifestInstance = function (context) {
	        ...
	        /* tslint:enable:no-any */
	        // If the webpart was created between manifest v2 and this commit,
	        // rendering it would fail because it can't find the title.
	        // This ensures it doesn't happen by setting the first one as fallback.
	        if (!manifestInstance.title) {
	            lodash.merge(manifestInstance, manifest.preconfiguredEntries[0]);
	        }
	        return manifestInstance;
	    };
	    /**
	     * Disable all buttons, that are a part of the web part dom subtree, from causing postbacks
	     * in classic SharePiont pages.
	     */
	    ClientSideWebPartManager.prototype._disableButtonPostbacksForClassicPages = function (domElement) {
	        if (this._environment.type === sp_client_base_1.EnvironmentType.ClassicSharePoint) {
	            ...
	            if (buttons && buttons.length) {
	                for (var i = 0; i < buttons.length; i++) {
	                    if (buttons[i]) {
	                        /* tslint:disable */
	                        /**
	                         * This is a temporary fix to disable the postbacks in classic pages. This works well with React
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @alpha
	 */
	/* tslint:disable:no-any */ // No state yet
	var PlaceholderSpinner = (function (_super) {
	    ...
	    PlaceholderSpinner.prototype.render = function () {
	        return (React.createElement("div", {className: 'Placeholder'}, React.createElement("div", {className: 'Placeholder-spinnerContainer'}, React.createElement(office_ui_fabric_react_1.Spinner, {type: office_ui_fabric_react_1.SpinnerType.large, label: this.props.label}))));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var PropertyPaneDefinitions_1 = __webpack_require__(3);
	var PropertyPaneController_module_scss_1 = __webpack_require__(179);
	/**
	...
	var PropertyPaneController = (function () {
	    ...
	    PropertyPaneController.prototype._renderPropertyPane = function (currentWebpart, shouldRecreatePropertyPaneElement, resetPropertyPaneState) {
	        ...
	        __webpack_require__.e/* nsure */(3, function (require) {
	            var propertyPane = __webpack_require__(183)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* tslint:disable */
	var styles = {
	    propertyPaneContainer: 'propertyPaneContainer_077fb410',
	    showPane: 'showPane_a6c5207c',
	    shrinkContent: 'shrinkContent_2177ccf7',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = styles;
	/* tslint:enable */
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "[id^=spPropertyPaneContainer].propertyPaneContainer_077fb410{position:absolute;top:50px;bottom:0}html[dir=ltr] [id^=spPropertyPaneContainer].propertyPaneContainer_077fb410{right:-340px}html[dir=rtl] [id^=spPropertyPaneContainer].propertyPaneContainer_077fb410{left:-340px}html[dir=ltr] [id^=spPropertyPaneContainer].showPane_a6c5207c{right:0}html[dir=rtl] [id^=spPropertyPaneContainer].showPane_a6c5207c{left:0}html[dir=ltr] [id^=spPageChromeAppDiv].shrinkContent_2177ccf7{right:340px}html[dir=rtl] [id^=spPageChromeAppDiv].shrinkContent_2177ccf7{left:340px}html[dir=ltr] [id^=workbenchPageContent].shrinkContent_2177ccf7{right:340px}html[dir=rtl] [id^=workbenchPageContent].shrinkContent_2177ccf7{left:340px}html[dir=ltr] [id^=workbenchCommandBar].shrinkContent_2177ccf7{padding-right:340px}html[dir=rtl] [id^=workbenchCommandBar].shrinkContent_2177ccf7{padding-left:340px}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var ClientSideComponentContext_1 = __webpack_require__(206);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Shell_1 = __webpack_require__(211);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var sp_client_base_1 = __webpack_require__(69);
	var SuiteNavManager_1 = __webpack_require__(212);
	var SPPageChrome_1 = __webpack_require__(219);
	var PreloadedDataReader_1 = __webpack_require__(225);
	var AppPageContext_1 = __webpack_require__(87);
	/**
	...
	var Shell = (function () {
	    ...
	    Shell.prototype.start = function (module, preloadedData) {
	        ...
	        return this._startApplication(module.default || module);
	    };
	    Shell.prototype._startApplication = function (application) {
	        ...
	        return new Promise(function (resolve, reject) {
	            ...
	            var qosMonitor = new sp_client_base_1._QosMonitor('ClientApplication');
	            try {
	                ...
	                qosMonitor.writeUnexpectedFailure('GeneralError', e);
	                reject(e);
	            }
	        });
	    };
	    Shell.prototype._initializePreload = function (preloadedData) {
	        ...
	        this._rootServiceScope.provide(sp_client_base_1._logSourceServiceKey, Shell._logSource);
	    ...
	    Shell.prototype._initializePageContextFromAppContext = function (pageContext, appPageContext) {
	        pageContext.initialize({
	            ...
	            user: {
	                ...
	                email: appPageContext.user.getOdataObject() ?
	                    appPageContext.user.getOdataObject().Email :
	                    '',
	            ...
	            web: {
	                ...
	                permissions: appPageContext.core.userPermissionsForWeb.value,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_module_loader_1 = __webpack_require__(171);
	var odsp_utilities_bundle_1 = __webpack_require__(6);
	var ISuiteNavDataSource_1 = __webpack_require__(213);
	var SPOSuiteNavDataSource_1 = __webpack_require__(214);
	var OnPremSuiteNavDataSource_1 = __webpack_require__(215);
	var O365ShellWrapper_1 = __webpack_require__(216);
	var SPPageChrome_1 = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	"use strict";
	var FlexPaneWrapper_1 = __webpack_require__(217);
	var NavigationWrapper_1 = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	__webpack_require__(103);
	var SPThemeProvider_1 = __webpack_require__(220);
	var sp_client_base_1 = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(69);
	var AppPageContext_1 = __webpack_require__(87);
	var SPWebTemplateIds_1 = __webpack_require__(221);
	...
	var PreloadedDataReader = (function () {
	    function PreloadedDataReader(preloadedData) {
	        ...
	        if (this._preloadedData === undefined ||
	            ...
	            sp_client_base_1._TraceLogger.logVerbose(PreloadedDataReader._logSource, 'Warning: PreloadedDataReader: No preloaded data was found');
	        }
	        else {
	            this._isValid = true;
	        ...
	        if (this._isValid) {
	            ...
	            if (this._preloadedData.contextWebInfo
	                ...
	                serviceScope.whenFinished(function () {
	                    ...
	                    sp_client_base_1._TraceLogger.logVerbose(PreloadedDataReader._logSource, 'PreloadedDataReader: Added preloaded FormDigestValue to cache');
	    ...
	    PreloadedDataReader._logSource = sp_client_base_1._LogSource.create('PreloadedDataReader');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Placeholder = (function (_super) {
	    ...
	    Placeholder.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: css_1.css('Placeholder', this.props.contentClassName)}, React.createElement("div", {className: 'Placeholder-container ms-Grid'}, React.createElement("div", {className: 'Placeholder-head ms-Grid-row'}, React.createElement("div", {className: 'ms-Grid-col ms-u-hiddenSm ms-u-md3'}), React.createElement("div", {className: 'Placeholder-headContainer ms-Grid-col ms-u-sm12 ms-u-md6'}, React.createElement("i", {className: 'Placeholder-icon ms-fontSize-su ms-Icon ' + this.props.icon}), React.createElement("span", {className: 'Placeholder-text ms-fontWeight-light ms-fontSize-xxl'}, this.props.iconText)), React.createElement("div", {className: 'ms-Grid-col ms-u-hiddenSm ms-u-md3'})), React.createElement("div", {className: 'Placeholder-description ms-Grid-row'}, React.createElement("span", {className: 'Placeholder-descriptionText', id: this._descriptionId}, this.props.description)), React.createElement("div", {className: 'Placeholder-description ms-Grid-row'}, this.buttonElement))));
	    };
	    Object.defineProperty(Placeholder.prototype, "buttonElement", {
	        ...
	        get: function () {
	            var _this = this;
	            // VSO:Bug 227377 There is a bug in fabric react button that it is not assigning the correct id to
	            // aria-labelledBy that confuses the screen reader. Added an extra aria-label to fix that
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	"use strict";
	var sp_client_base_1 = __webpack_require__(69);
	var ClassicPageHost_1 = __webpack_require__(241);
	var ClientSideWebPartManager_1 = __webpack_require__(170);
	var PropertyPaneDefinitions_1 = __webpack_require__(3);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClassicPageHost = (function () {
	    ...
	    ClassicPageHost.prototype.webPartConfigurationEventCallback = function (event, data) {
	        if (event === PropertyPaneDefinitions_1.WebPartConfigurationEvent.PropertyPaneConfigurationComplete) {
	            this._setData(data);
	        }
	    };
	    /* tslint:disable:no-any */
	    ...
	    ClassicPageHost.prototype._ensureInitialized = function () {
	        ...
	        pageContext.initialize({
	            ...
	            web: {
	                ...
	                permissions: window[pageContextInfoName].webPermMasks,
	        ...
	        // Initialize the environment to Classic page
	        var environment = serviceScope.createDefaultAndProvide(sp_client_base_1.environmentServiceKey);
	        environment._initialize(sp_client_base_1.EnvironmentType.ClassicSharePoint);
	        serviceScope.finish();
	        this._serviceScope = serviceScope;
	    };

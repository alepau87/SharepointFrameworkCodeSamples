...
var OrgChartPage_1 = require('../../pages/OrgChartPage/OrgChartPage');
...
var PersonaCardPage_1 = require('../../pages/PersonaCardPage/PersonaCardPage');
    ...
    examplePages: [
        {
            links: [
                ...
                {
                    component: OrgChartPage_1.OrgChartPage,
                    name: 'OrgChart',
                    status: ExampleStatus.placeholder,
                ...
                {
                    component: PersonaCardPage_1.PersonaCardPage,
                    name: 'PersonaCard',
                    status: ExampleStatus.placeholder,
